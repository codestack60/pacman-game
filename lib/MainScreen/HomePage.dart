...
import '../Ghosts/ghost.dart';
import '../Ghosts/ghost3.dart';
import '../Ghosts/ghost2.dart';
import '../util/path.dart';

import '../util/pixel.dart';
...
// The message to display.
  ...
  // @override
  // void initState() {
  //   String bannerId= Platform.isAndroid? 'ca-app-pub-7779055038047890/9230922296':'ca-app-pub-7779055038047890/9230922296';
  ...
  Future<bool> _onBackButtonPressed(BuildContext context) async{
    bool exitApp = await showDialog(
        ...
        builder: (BuildContext context){
          return AlertDialog(
            title: SizedBox(
              height: 100,width: 100,child: Image.asset('assets/images/pacman.png'),
            ),
            content: Text('Do you want to exit pacman ? ',style: TextStyle(color: Color(0xFF302b63),fontSize: 19),),
            actions: <Widget>[
              ...
              TextButton(onPressed: (){
                ...
                // InterstitialAd.load(
                //
                //     adUnitId:  Platform.isAndroid?'ca-app-pub-7779055038047890/1079317142':'ca-app-pub-7779055038047890/1079317142',
                //     request: AdRequest(
                //       keywords: ['Medical','School','Finance','Banking'],
                //     ),
